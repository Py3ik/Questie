...
# Installation
- [Download](https://github.com/Py3ik/Questie/archive/refs/heads/master.zip) the archive.
- Extract it into `Interface/AddOns/` directory, folder name should be `Questie-master.`.
